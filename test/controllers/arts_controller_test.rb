...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { description: @art.description, price: @art.price, size: @art.size, title: @art.title, user_id: @art.user_id } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { description: @art.description, price: @art.price, size: @art.size, title: @art.title, user_id: @art.user_id } }
